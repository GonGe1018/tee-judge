"""Fix manifest v3: correct encrypted_files syntax for Gramine 1.8."""
...
env.TEE_JUDGE_SEALED_KEY = "/home/judgeclient/tee-judge/.sealed/enclave_key.pem"
...
# Encrypted mount for sealed key storage
[[fs.mounts]]
uri = "file:/home/judgeclient/tee-judge/.sealed"
path = "/home/judgeclient/tee-judge/.sealed"
type = "encrypted"
key_name = "default"
...
print("\n=== Create sealed dir ===")
ssh_run(
    "mkdir -p ~/tee-judge/.sealed && rm -f ~/tee-judge/.sealed/*.pem ~/tmp/.tee-judge-sealed-key.pem; echo done"
)
...
print("\n=== Quick test ===")
ssh_run(
    'cd ~/tee-judge && echo \'{"task":{},"host_results":{"status":"CE","outputs":[]}}\' | timeout 20 gramine-sgx python3 2>&1 | tail -5'
)
