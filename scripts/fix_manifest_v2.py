"""Fix manifest v2: simpler argv, no insecure options."""
...
# Create a fixed enclave entry script (trusted_file)
print("=== Create enclave entry script ===")
ENTRY_SCRIPT = """import sys, os, json
...
"""
sftp_write("/home/judgeclient/tee-judge/client/enclave_entry.py", ENTRY_SCRIPT)
...
print("\n=== Quick test ===")
ssh_run("cd ~/tee-judge && echo '{}' | timeout 15 gramine-sgx python3 2>&1 | head -5")
