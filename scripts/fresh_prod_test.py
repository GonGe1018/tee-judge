"""Fresh production test: new DB, new keys, full chain."""
...
print("User + Judge tokens OK")

# Start daemon (fresh key)
print("\n=== Start daemon ===")
ssh_run(
    "pkill -9 -f daemon.py 2>/dev/null; sleep 1; rm -f /tmp/.tee-judge-sealed-key.pem; echo cleaned"
)
start_bg(
